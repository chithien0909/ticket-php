...
<li class="date"><input type="text" class="datepicker date_add" name="date_add" value="<?=$today; ?>" /></li>
	<li>
	...
	<a href="javascript:;" class="add_time" data-date="<?=$today; ?>" onclick="addTime($(this));"><img src="../images/add.png" /></a>
