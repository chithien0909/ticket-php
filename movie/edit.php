...
<div class="heading">Movies Edit</div>
<form action="" class="form" method="post">
    ...
    <section>
        <dl>
            ...
            <dd>
                <?php echo $movie->form->input('is_public'); ?>
                <?php echo $movie->form->error('is_public'); ?>
            </dd>
        </dl>
    </section>
    ...
    <section>
        <dl>
            ...
            <dd>
                <?php echo $movie->form->input('image'); ?>
                <?php echo $movie->form->error('image'); ?>
            </dd>
        </dl>
    </section>
    <section>
